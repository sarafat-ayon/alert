<template>
  ...
  >
    ...
    ></div>
    <div
      :class="activeComponent === 'Search' ? 'active' : ''"
      class="
        tab
        cursor-pointer
        rounded-full
      ...
      "
      data-index="0"
      @click="showTabMenu('Search'), animate()"
    >
      <span class="pointer-events-none text-lg font-bold">Search</span>
    </div>
    <div
      :class="activeComponent === 'Onboard' ? 'active' : ''"
      class="
        tab
        cursor-pointer
        rounded-full
      ...
      "
      data-index="1"
      @click="showTabMenu('Onboard'), animate()"
    >
      <span class="pointer-events-none text-lg font-bold">Onboard</span>
    </div>
  </div>
</template>
...
.content__tabs {
  ...
  .background__circle {
    ...
    z-index: 1;
    @apply shadow-2xl absolute h-full rounded-full inline-block;
  }
  .tab {
