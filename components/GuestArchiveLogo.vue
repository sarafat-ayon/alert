<template>
  <svg
    id="Layer_1"
    class="sharpArchiveLogo absolute md:left-13 transform md:translate-x-0"
    height="100"
    data-name="Layer 1"
    ...
    :class="[
      $route.name === 'payment'
        ? 'left-8 top-8 translate-x-0'
        : 'left-1/2 -translate-x-1/2 top-13',
      hideFeedConnect ? 'md:z-9999 z-999' : 'z-99999',
    ]"
  >
    <defs>
      <style>
    ...
    />
    <path class="guestarchivelogo-13" d="M387.94,590.84V547h3.32v43.84Z" />
    <path
      class="guestarchivelogo-13"
