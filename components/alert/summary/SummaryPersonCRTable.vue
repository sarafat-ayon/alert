...
export default defineComponent({
  setup() {
    ...
    const { summaryComp, startValue, endValue, currentComp, showHideFullSummaryTable } = storeToRefs(store)
