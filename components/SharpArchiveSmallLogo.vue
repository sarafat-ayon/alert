<template>
  ...
  <!-- :class="[starterExpanded ? 'logo-left' : 'logo-center']" -->
  <svg
    id="Layer_1"
    class="
      sharpArchiveLogo
  ...
  >
    ...
    />
    <path class="sharparchivesmalllogo-13" d="M387.94,590.84V547h3.32v43.84Z" />
    <path
      class="sharparchivesmalllogo-13"
...
export default {
  name: 'SharpArchiveSmallLogo',
  props: ['position', 'upLogoIndex'],
  computed: {
    ...mapState({
...
.sharpArchiveLogo {
  ...
  &.logo-left {
    ...
    height: 80px;
    width: 6.25rem;
    // @apply md:h-15 md:w-15 md:left-10 md:top-1 md:transform-none 2xl:left-14 h-16 w-16 left-1/2 top-1/4 transform -translate-x-8 -translate-y-9;
  }

  &.logo-center {
    @apply top-24 left-1/2 lg:w-34 w-26;
...
@media (max-width: 768px) {
  .logo-left {
    // @apply top-20 left-1/2 md:w-34 w-26;
    top: 7rem !important;
    left: 50% !important;
