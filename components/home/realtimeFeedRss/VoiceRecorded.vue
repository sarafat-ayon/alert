<template>
  ...
  >
    ...
    <div
      ref="all"
      :class="activeComponent === 'All' ? 'active' : ''"
      class="
        tab
        cursor-pointer
        rounded-full
    ...
    <div
      ref="voicemails"
      :class="activeComponent === 'Voicemails' ? 'active' : ''"
      class="
        tab
        cursor-pointer
        rounded-full
      ...
      "
      data-index="1"
      @click="showTabMenu('Voicemails'), animate()"
    >
      <span class="pointer-events-none xl:text-lg md:text-md text-sm font-bold"
        >Voicemails</span
      >
    ...
    <div
      ref="recordedcalls"
      :class="activeComponent === 'Recorded Calls' ? 'active' : ''"
      class="
        tab
        cursor-pointer
        rounded-full
      ...
      "
      data-index="2"
      @click="showTabMenu('Recorded Calls'), animate()"
    >
      <span class="pointer-events-none xl:text-lg md:text-md text-sm font-bold"
        >Recorded Calls</span
      >
