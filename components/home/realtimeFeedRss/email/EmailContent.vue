      ...
      <transition v-if="!showEmail.selected" name="fadeIn">
        ...
        >
          <div class="name-wrapper flex space-x-2 justify-between items-center">
            <div v-if="showEmail.from" class="mail-name text-lg">
              {{ showEmail.from }}
          ...
          <div v-if="showEmail.updatedAt" class="date">
            <DateTime
              :datetime="showEmail.updatedAt"
        ...
        >
          ...
          <div class="from">
            <p>
              ...
              {{ showEmail.from }} {{ showEmail.email }}
            </p>
          </div>
          <div class="flex space-x-1">
            ...
            <div>
              <div
                v-for="(toEmail, toEmailIndex) in showEmail.to"
                :key="toEmailIndex"
                class="to"
              >
                <span>
                  {{ toEmail === allEmails.username ? allEmails.name : '' }} ({{
                    toEmail
                  }})
                </span>
                <span v-if="toEmailIndex !== showEmail.to.length - 1">,</span>
              </div>
            </div>
          </div>
          <!-- <div class="to">
